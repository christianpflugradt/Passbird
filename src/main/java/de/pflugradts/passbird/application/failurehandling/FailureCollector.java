...
import de.pflugradts.passbird.application.failurehandling.failure.ChecksumFailure;
import de.pflugradts.passbird.application.failurehandling.failure.ClipboardFailure;
import de.pflugradts.passbird.application.failurehandling.failure.CommandFailure;
import de.pflugradts.passbird.application.failurehandling.failure.DecryptPasswordDatabaseFailure;
import de.pflugradts.passbird.application.failurehandling.failure.ExportFailure;
import de.pflugradts.passbird.application.failurehandling.failure.Failure;
import de.pflugradts.passbird.application.failurehandling.failure.ImportFailure;
import de.pflugradts.passbird.application.failurehandling.failure.InputFailure;
import de.pflugradts.passbird.application.failurehandling.failure.PasswordEntriesFailure;
import de.pflugradts.passbird.application.failurehandling.failure.PasswordEntryFailure;
import de.pflugradts.passbird.application.failurehandling.failure.RenamePasswordEntryFailure;
import de.pflugradts.passbird.application.failurehandling.failure.SignatureCheckFailure;
import de.pflugradts.passbird.application.failurehandling.failure.WritePasswordDatabaseFailure;
